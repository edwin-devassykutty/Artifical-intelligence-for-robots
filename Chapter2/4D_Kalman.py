...
def filter(x, P, x_1, y_1):
    ...
    for n in range(len(measurements)):
        ...
        a1 = vars(x)  # seperates the individual items in an instance
        new = a1.values()
        print(new)
        x_new.append(new[2][0])
        y_new.append(new[2][1])
    ...
    print 'P= '
    P.show()
    plt.plot(x_1, y_1, 'bo', x_new, y_new, 'g')
    plt.show()
...
measurements = [[5., 11.], [6., 8.5], [7.1, 6.3], [8.1, 7.3], [9.3, 2.2], [10.5, 0.3]]
x_m = [t[0] for t in measurements]
y_m = [t[1] for t in measurements]
...
R = matrix([[0.1, 0.], [0.1, 1.]]) # measurement uncertainty: use 2x2 matrix with 0.1 as main diagonal
